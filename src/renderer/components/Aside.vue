<template>
  <div class="aside">
    <div class="top">
      ...
      <!-- <n-popover trigger="hover" placement="right">
        <template #trigger>
          <n-button circle type="primary" size="large" @click="goView('download')" :dashed="active === 'download'" v-show="false" :quaternary="active !== 'download'">
            <n-icon size="20">
    ...
    <div class="bottom">
      ...
      <n-popover trigger="hover" placement="right-end">
        <template #trigger>
          <n-button circle type="primary" size="large" :quaternary="!['settings', 'siteManager', 'liveManager'].includes(active)" :dashed="['settings', 'siteManager', 'liveManager'].includes(active)">
        ...
        <template #default>
          ...
          <n-button @click="goView('about')" text>
            <template #icon
              ><n-icon size="16"><WaterOutline /></n-icon
            ></template>
            {{ $t('menu.about') }}
          </n-button>
        </template>
...
import { PrismSharp, Tv, Play, Heart, Time, Notifications, Settings, Menu, ConstructOutline, Build, WaterOutline } from '@vicons/ionicons5'
