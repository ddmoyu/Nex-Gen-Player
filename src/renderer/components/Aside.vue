      ...
      <n-popover trigger="hover" placement="right">
        <template #trigger>
          <n-button
            ...
            type="primary"
            size="large"
            @click="goView('discovery')"
            :dashed="active === 'discovery'"
      ...
      <n-popover trigger="hover" placement="right">
        <template #trigger>
          <n-button
            ...
            type="primary"
            size="large"
            @click="goView('history')"
            :dashed="active === 'history'"
      ...
      <n-popover trigger="hover" placement="right">
        <template #trigger>
          <n-button
            ...
            type="primary"
            size="large"
            @click="goView('download')"
            :dashed="active === 'download'"
            v-show="false"
